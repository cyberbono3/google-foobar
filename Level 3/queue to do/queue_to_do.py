...
https://pastebin.com/ckPCJkiz
https://github.com/search?q=queue+to+do+foobar


"""

class Solution:
    def compute_check_sum(self, start, length):
        # Your code here
        ...
        return res
sol = Solution()
print(sol.compute_check_sum(0,3) == 2)
print(sol.compute_check_sum(17,4) == 14)
